...
> 状态：已完成（2026-08-17）。畸形载荷 fuzz（发现并修复 2 处越界 panic）、并发压力、零落盘与最小监听面子进程验证（ACC-P5-001/003/004）、`-version` 标志与 CHANGELOG；**v0.1.0 已发布**（签名 tag + GitHub Release + 12 平台产物，ACC-P5-002）。
...
| 2026-08-17 | v0.1.0 发布：签名 tag（EDDSA BCCD6EE8）、GitHub Release（12 平台产物 + 发布说明/SBOM） |
